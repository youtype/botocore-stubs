...
def get_checksum_algorithm_headers(params: Mapping[str, Any]) -> list[str]: ...
...
def generate_login_cache_key(sign_in_session_name: str) -> str: ...
...
def get_login_token_cache_directory() -> str: ...

class LoginTokenLoader:
    def __init__(self, cache: dict[str, Any] | None = ...) -> None: ...
    def save_token(self, session_name: str, token: str) -> None: ...
    def load_token(self, session_name: str) -> str | None: ...
