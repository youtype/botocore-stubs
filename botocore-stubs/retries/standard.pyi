...
class ExponentialBackoff(BaseRetryBackoff):
    def __init__(
        ...
        service_name: str | None = ...,
        throttling_detector: ThrottlingErrorDetector | None = ...,
    ) -> None: ...
...
class ThrottlingErrorDetector:
    ...
    def is_throttling_error(self, **kwargs: Any) -> bool: ...
    def is_throttling_error_from_context(self, context: RetryContext) -> bool: ...
...
class RetryQuotaChecker:
    def __init__(
        self, quota: Any, throttling_detector: ThrottlingErrorDetector | None = ...
    ) -> None: ...
